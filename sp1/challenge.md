...
I personally, learn the best when I explain something to someone. Even when I feel like I don't understand something, sometimes I realize that I do understand it while explaining. Code review helps to see someone else's point of view or solution of the same problem. It not only helps a person whose code is being reviewed but also to a reviewer by practicing. It also helps to reduce a risk of unnoticed mistakes. I pay attention to things like whether a code runs by itself or it needs a user's adjustments to a code or modifications before it starts running and whether the objective of an assignment has been met. 
...
- We have an awful lot of computers here, and it gets pretty confusing with
  ...
  A container basically can help a code to run on any machine. A container image is an executable package of a piece of software that includes everything needed to run it. That includes code, runtime, system tools, system libraries, settings. Basically it will help all the computers regardless of the operating system or environment to run a code without any adjustments.  
